...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div x-data="personnelTableComponent(
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider w-24">
                            H.H
                        </th>
                        <th scope="col"
                            class="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            <td class="px-4 py-3" style="overflow: visible;">
                                ...
                                <div x-data="{ 
                                    ...
                                    }" class="relative w-full min-w-[280px]" @click.away="open = false">
                                    <!-- Trigger Button -->
                                    <button type="button" @click="if (!isDisabled) open = !open" :disabled="isDisabled"
                                                ...
                                                <span class="flex items-center gap-2">
                                                    <span
                                                        ...
                                                        <span
                                                            ...
                                                            x-text="selectedEmployee.name.split(' ').map(n => n[0]).join('').substring(0,2).toUpperCase()"></span>
                                                    </span>
                                                    <span class="block truncate text-gray-900 dark:text-gray-100"
                                                        x-text="selectedEmployee.name"></span>
                                                </span>
                                            </template>
                                            <template x-if="!selectedEmployee">
                                        ...
                                        <!-- Clear button -->
                                        <span x-show="selectedEmployee && !isDisabled" @click.stop="clearSelection()"
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                        ...
                                        <ul class="max-h-60 overflow-auto py-1 text-sm">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <span
                                                            ...
                                                            <span
                                                                ...
                                                                x-text="emp.name.split(' ').map(n => n[0]).join('').substring(0,2).toUpperCase()"></span>
                                                        </span>
                                                        <div class="flex-1 min-w-0">
                                                            <p class="text-gray-900 dark:text-gray-100 font-medium truncate"
                                                                x-text="emp.name"></p>
                                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate"
                                                                x-text="positions[emp.position_id] || 'Sin cargo'"></p>
                                                        </div>
                                                        <svg x-show="row.employee_id == emp.id"
                                            ...
                                            <!-- Empty State -->
                                            <li x-show="filteredEmployees.length === 0"
                                                class="py-6 px-3 text-center text-gray-500 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <input type="number" x-model="row.hh" @input="updateState()" :disabled="isDisabled"
                            ...
                            <td class="px-4 py-3">
                                <span x-text="getPositionName(row.employee_id)"
                                    class="inline-block w-full min-w-[200px] px-3 py-2 rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm"></span>
                            </td>
